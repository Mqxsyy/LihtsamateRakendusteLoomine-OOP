...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-3qs3925463692_api1.business.example.com";
    private string APIPassword = "9TM3MMHDHBGNE797";
    private string APISignature = "A8-JJRGtmaiKNuBuoJ70.laPkNhIAIygbdIvtUvivZp7dTfZrGwvWpbH";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44318/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44318/Checkout/CheckoutCancel.aspx";
